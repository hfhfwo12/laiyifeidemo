...
public class OrderActivity extends Activity {
	...
	private void InitViewPager() {
		...
		listViews.add(mInflater.inflate(R.layout.activity_order_menu1, null));
		listViews.add(mInflater.inflate(R.layout.activity_order_menu2, null));
		listViews.add(mInflater.inflate(R.layout.activity_order_menu3, null));
		listViews.add(mInflater.inflate(R.layout.activity_order_menu4, null));
		listViews.add(mInflater.inflate(R.layout.activity_order_menu5, null));
		listViews.add(mInflater.inflate(R.layout.activity_order_menu6, null));
